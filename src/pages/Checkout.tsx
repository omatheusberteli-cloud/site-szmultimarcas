...
export default function Checkout() {
  ...
  return (
    <div className="pt-28 pb-24 px-4 sm:px-8 max-w-7xl mx-auto min-h-screen text-gray-900 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 pb-6 border-b border-gray-200 gap-4">
        <div>
          <button 
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-xs text-gray-500 hover:text-gray-900 uppercase tracking-widest mb-2 transition-colors"
          >
            <ArrowLeft className="w-3.5 h-3.5" /> Voltar à loja
          </button>
          <h1 className="text-3xl font-serif italic text-gray-900">Checkout <span className="text-orange-500 font-sans not-italic font-bold">Seguro</span></h1>
        </div>

        <div className="flex items-center gap-4 bg-gray-100 border border-gray-200 px-4 py-2.5 rounded-none text-[10px] uppercase tracking-widest font-mono text-gray-700">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 sm:p-8 relative">
            <div className="flex items-center gap-3 mb-6 border-b border-gray-200 pb-4">
              ...
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-gray-900">Dados de Identificação & Contato</h2>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2 space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Nome Completo *</Label>
                <Input
                  required
                  placeholder="Ex: Gabriel Silva"
                  value={formData.name}
                  onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                  className="bg-gray-100 border-gray-200 h-11 text-sm rounded-none focus:border-orange-500 text-gray-900"
                />
              </div>

              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">E-mail para Confirmação *</Label>
                <Input
                  required
                  type="email"
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">CPF *</Label>
                <Input
                  required
              ...
              <div className="sm:col-span-2 space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">WhatsApp / Telefone para Atualizações de Envio *</Label>
                <Input
                  required
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 sm:p-8 relative">
            <div className="flex items-center gap-3 mb-6 border-b border-gray-200 pb-4">
              ...
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-gray-900">Endereço de Entrega</h2>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">CEP *</Label>
                <div className="relative">
                  <Input
                    ...
                    className="bg-gray-100 border-gray-200 h-11 text-sm rounded-none focus:border-orange-500 text-gray-900"
                  />
                  {loadingCep && <span className="absolute right-3 top-3 text-[10px] text-orange-500 font-mono animate-pulse">Buscando...</span>}
                </div>
              </div>

              <div className="sm:col-span-2 space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Rua / Logradouro *</Label>
                <Input
                  required
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Número *</Label>
                <Input
                  required
                  placeholder="123"
              ...
              <div className="sm:col-span-2 space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Complemento (Apto, Bloco)</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Bairro *</Label>
                <Input
                  required
                  placeholder="Bairro"
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">Cidade *</Label>
                <Input
                  required
                  placeholder="Cidade"
                  value={formData.city}
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] uppercase tracking-widest text-gray-500">UF / Estado *</Label>
                <Input
                  required
                  placeholder="SP"
                  maxLength={2}
                  ...
                  className="bg-gray-100 border-gray-200 h-11 text-sm rounded-none focus:border-orange-500 uppercase text-gray-900"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 sm:p-8 relative">
            <div className="flex items-center gap-3 mb-6 border-b border-gray-200 pb-4">
              ...
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-gray-900">Método de Envio</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div 
                ...
                className={`p-4 border cursor-pointer transition-all flex items-start gap-4 ${
                  shippingOption === "sedex" 
                    ? "bg-orange-500/10 border-orange-500 text-gray-900" 
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-gray-500">Prazo de entrega: 2 a 4 dias úteis</p>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-gray-500">Prazo de entrega: 5 a 8 dias úteis</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 p-6 sm:p-8 relative">
            <div className="flex items-center gap-3 mb-6 border-b border-gray-200 pb-4">
              ...
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-gray-900">Pagamento via WhatsApp</h2>
            </div>

            <div className="bg-green-50 border border-green-200 p-6 space-y-4">
              <div className="flex items-center gap-3 mb-2">
                <MessageCircle className="w-6 h-6 text-green-600" />
                <h3 className="text-sm font-bold text-gray-900">Finalize seu pedido pelo WhatsApp</h3>
              </div>
              <p className="text-xs text-gray-600 leading-relaxed">
                Ao clicar em "Enviar Pedido via WhatsApp", você será redirecionado para o WhatsApp da Real Store com todos os detalhes do seu pedido. Lá você combinará a forma de pagamento e receberá as instruções para finalizar a compra.
              </p>
          ...
          >
            {isSubmitting ? (
              ...
              <>
                ...
                Enviar Pedido via WhatsApp (R$ {finalTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })})
              </>
            )}
          </Button>
          ...
          <div className="sticky top-28 space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 p-6 space-y-6">
              <div className="flex justify-between items-center border-b border-gray-200 pb-4">
                <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-gray-900">Resumo do Pedido</h3>
                <span className="text-[10px] font-mono text-gray-500">{cart.length} itens</span>
              </div>

              {/* Items Preview */}
              <div className="space-y-3 max-h-60 overflow-y-auto pr-2 divide-y divide-gray-200">
                {cart.map((item) => (
                  <div key={item.id} className="pt-3 first:pt-0 flex items-center gap-3">
                    <div className="w-12 h-14 bg-gray-200 border border-gray-300 shrink-0 overflow-hidden">
              ...
              <div className="space-y-2 pt-4 border-t border-gray-200 text-xs font-mono">
                ...
                <div className="flex justify-between text-gray-600">
                  ...
                  <span>{shippingCost === 0 ? <strong className="text-green-600">GRÁTIS</strong> : `R$ ${shippingCost.toFixed(2).replace('.', ',')}`}</span>
                </div>

                <div className="flex justify-between items-end pt-4 border-t border-gray-200 text-sm">
                  <div>
                    <span className="text-[10px] text-gray-500 uppercase tracking-widest block font-sans">Valor Total</span>
                    <span className="text-2xl font-bold text-gray-900">R$ {finalTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  {couponDiscountValue > 0 && <span className="text-[9px] text-green-600 bg-green-50 px-2 py-1 border border-green-200 uppercase font-bold">Economizou R$ {couponDiscountValue.toFixed(2).replace('.', ',')}</span>}
                </div>
              </div>
            ...
            <div className="bg-gray-50 border border-gray-200 p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 text-[10px] text-gray-600 uppercase tracking-wider">
                ...
                <span>REAL STORE — Curadoria de Luxo Oficial</span>
              </div>
            </div>
