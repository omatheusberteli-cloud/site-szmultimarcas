...
export default function Home() {
  ...
  const categoriesCircles = [
    { name: "Camisas", cat: "camisa", img: "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=300&q=80" },
    ...
    { name: "Bermudas", cat: "bermuda", img: "https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=300&q=80" },
  ...
  return (
    <div className="w-full text-white font-sans pt-8">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto space-y-6">
          ...
          >
            <Button 
              ...
              size="lg" 
              className="rounded-none bg-white text-black hover:bg-orange-500 hover:text-white transition-all px-10 h-14 text-[10px] uppercase tracking-[0.3em] font-extrabold group shadow-2xl"
            >
            ...
            <Button 
              ...
              size="lg" 
              className="rounded-none border border-white/30 bg-black/60 hover:bg-white hover:text-black text-white transition-all px-8 h-14 text-[10px] uppercase tracking-[0.3em] font-extrabold shadow-xl"
            >
              Ver Coleção Camisas
            </Button>
          </motion.div>
